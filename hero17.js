              ...
              {props.content1 ?? (
                <Fragment>
                  <p className="hero17-text8 thq-body-large">
                    Browse through our portfolio of stunning website projects
                    and order our services to bring your vision to life.
                  </p>
                </Fragment>
              )}
            </p>
...
Hero17.defaultProps = {
  ...
  image7Alt: 'Order Now',
  image12Alt: 'Professional Services',
  image2Alt: 'Web Design',
  image6Src:
  ...
  image11Alt: 'Customized Websites',
  action2: undefined,
  action1: undefined,
  image8Src:
  ...
  image10Alt: 'SEO Optimization',
  image4Alt: 'Portfolio Showcase',
  heading1: undefined,
  content1: undefined,
  image10Src:
  ...
  image9Alt: 'E-commerce Solutions',
  image1Src:
