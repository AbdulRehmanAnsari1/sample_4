            ...
            <h2>
              <slot name="feature1Title">
                ...
                <div class="features25-fragment4">
                  <h2 class="features25-text4 thq-heading-2">
            ...
            <h2>
              <slot name="feature2Title">
                ...
                <div class="features25-fragment3">
                  <h2 class="features25-text3 thq-heading-2">
            ...
            <h2>
              <slot name="feature3Title">
                ...
                <div class="features25-fragment6">
                  <h2 class="features25-text6 thq-heading-2">SEO Optimization</h2>
                </div>
              </slot>
            </h2>
            <span>
...
export default {
  ...
  props: {
    feature1ImgAlt: {
      type: String,
      default: 'Customized Website Design Image Alt Text',
    },
    feature3ImgAlt: {
      type: String,
      default: 'SEO Optimization Image Alt Text',
    },
    feature1ImgSrc: {
      type: String,
      default:
    ...
    feature2ImgAlt: {
      type: String,
      default: 'Responsive Web Development Image Alt Text',
    },
    feature2ImgSrc: {
      type: String,
      default:
