            ...
            <a :href="link1Url">
              <slot name="link1">
                ...
                <div class="navbar8-fragment14">
                  <span class="navbar8-text18 thq-link thq-body-small">#</span>
                </div>
              </slot>
            </a>
            <a :href="link2Url">
                    ...
                    <div class="navbar8-content1">
                      ...
                      <span>
                        <slot name="page1Description">
                          ...
                          <div>
                            <span>Welcome to our freelancing website</span>
                          </div>
                        </slot>
                      </span>
                    </div>
                    ...
                    <div class="navbar8-content2">
                      ...
                      <span>
                        <slot name="page2Description">
                          ...
                          <div><span>Check out our previous projects</span></div>
                        </slot>
                      </span>
                    </div>
                  </div>
                    ...
                    <div class="navbar8-content3">
                      ...
                      <span>
                        <slot name="page3Description">
                          ...
                          <div><span>Explore the services we offer</span></div>
                        </slot>
                      </span>
                    </div>
                  </div>
                    ...
                    <div class="navbar8-content4">
                      ...
                      <span>
                        <slot name="page4Description">
                          ...
                          <div><span>Get in touch with us</span></div>
                        </slot>
                      </span>
                    </div>
                  </div>
              ...
              <span>
                <slot name="action1">
                  ...
                  <div class="navbar8-fragment11">
                    <span class="navbar8-text15">Order Now</span>
                  </div>
                </slot>
              </span>
            </button>
              ...
              <span>
                <slot name="action2">
                  ...
                  <div class="navbar8-fragment23">
                    <span class="navbar8-text27">Contact Us</span>
                  </div>
                </slot>
              </span>
            </button>
                ...
                <span>
                  <slot name="page2">
                    ...
                    <div class="navbar8-fragment16">
                      <span class="navbar8-text20 thq-body-large">Portfolio</span>
                    </div>
                  </slot>
                </span>
                <span>
                ...
                <span>
                  <slot name="page3">
                    ...
                    <div class="navbar8-fragment21">
                      <span class="navbar8-text25 thq-body-large">Services</span>
                    </div>
                  </slot>
                </span>
                <span>
                ...
                <span>
                  <slot name="page4">
                    ...
                    <div class="navbar8-fragment15">
                      <span class="navbar8-text19 thq-body-large">Contact</span>
                    </div>
                  </slot>
                </span>
                <span>
...
export default {
  ...
  props: {
    ...
    page2ImageAlt: {
      type: String,
      default: 'Image for Portfolio page',
    },
    linkUrlPage2: {
      type: String,
      default: 'https://www.teleporthq.io',
    ...
    logoAlt: {
      type: String,
      default: 'Freelancing Website Logo',
    },
    logoSrc: {
      type: String,
      default:
    ...
    page3ImageAlt: {
      type: String,
      default: 'Image for Services page',
    },
    linkUrlPage1: {
      type: String,
      default: 'https://www.teleporthq.io',
    ...
    page4ImageAlt: {
      type: String,
      default: 'Image for Contact page',
    },
    page2ImageSrc: {
      type: String,
      default:
