          ...
          <span>
            <slot name="action1">
              ...
              <div class="hero17-fragment2">
                <span class="hero17-text6 thq-body-small">Order Now</span>
              </div>
            </slot>
          </span>
        </button>
          ...
          <span>
            <slot name="action2">
              ...
              <div class="hero17-fragment1">
                <span class="hero17-text5 thq-body-small">View Portfolio</span>
              </div>
            </slot>
          </span>
        </button>
